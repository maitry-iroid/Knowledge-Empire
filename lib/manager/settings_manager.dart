  ...
  String get title {
    switch (this) {
      case SettingsOptions.language:
        return "Language";
      case SettingsOptions.switchMode:
        return "Switch mode";
      case SettingsOptions.sound:
        return "Sound";
      case SettingsOptions.selectCompany:
        return "Select company";
      case SettingsOptions.changePassword:
        return "Change passowrd";
      case SettingsOptions.privacyAndPolicy:
        return "Privacy and policy";
      case SettingsOptions.termsAnsConditions:
...
//      case SettingsOptions.selectCompany:       return true;
  ...
  Color get color {
    switch (this) {
      case SettingsOptions.logout:
        return ThemeManager().getBadgeColor();
      default:
...
extension LanguageBottomSheetOptionsExtension on LanguageBottomSheetOptions {
  String get title {
    switch (this) {
      case LanguageBottomSheetOptions.english:
        return "English";
      case LanguageBottomSheetOptions.german:
        return "German";
      case LanguageBottomSheetOptions.chinese:
        return "Chinese";
    }
  }
}

enum SwitchModeBottomSheetOptions { modernVersion, professionalVersion, gamifiedVersion }

extension SwitchModeBottomSheetOptionsExtension on SwitchModeBottomSheetOptions {
  String get title {
    switch (this) {
      case SwitchModeBottomSheetOptions.modernVersion:
        return "Modern";
      case SwitchModeBottomSheetOptions.professionalVersion:
        return "Prof";
      case SwitchModeBottomSheetOptions.gamifiedVersion:
        return "Game";
    }
  }
}
