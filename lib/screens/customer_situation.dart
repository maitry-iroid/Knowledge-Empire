...
class _CustomerSituationPageState extends State<CustomerSituationPage> {
  ...
  void updateChallenge(bool isAnswere) {
    ...
    if (index != -1) {
      Injector.countList[index].color = isAnswere ? ColorRes.greenDot : ColorRes.red;
...
//            gifImageShow(),
          ...
          child: Column(
            ...
            children: <Widget>[
              GridView.count(
                ...
                children: List.generate(questionDataCustomerSituation.answer.length, (index) {
  ...
  showMediaAnswersView(BuildContext context, String path) {
    ...
    } else if (Utils.isVideo(path) && _controller != null && _controller.value.initialized) {
      print("isVideo = true");
...
//                context, "Question"),
  ...
  showMediaView(BuildContext context) {
    ...
    } else if (Utils.isVideo(correctWrongImage()) && _controller.value.initialized) {
      return AspectRatio(
