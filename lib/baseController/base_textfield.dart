...
class BaseTextField extends TextFormField{
  ...
  BaseTextField({@required this.hintText, @required this.controller, this.fillColor, this.textInputType, this.isSecure, this.isEnabled, this.enableInteractiveSelection, this.focusNode, @required this.validator}) :
        super(
...
class SearchTextField extends TextFormField{
  ...
  SearchTextField({@required this.hintText, @required this.controller, this.fillColor, this.textInputType, this.isSecure, this.isEnabled, @required this.validator}) :
        super(
          controller: controller,
          enabled: isEnabled,
          keyboardType: textInputType ?? TextInputType.text,
          ...
          decoration: InputDecoration(
              enabledBorder: OutlineInputBorder(
                  borderSide: BorderSide(color: ThemeManager().getDarkColor(), width: 0.5),
