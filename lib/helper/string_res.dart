...
//  engage customer
  ...
  static Map<String, Map<String, String>> localizedValues = {
    ...
    'zh': {
      ...
      'endRel': '结束',
      'alertReleaseResources':
          "该客户将被移除，不会再产生任何收入，并且只能在忠诚度期后再次访问",
    ...
    'de':
     {
      ...
      'endRel': 'Entfernen',
      'alertReleaseResources': 'Dieser Frage wird entfert. Sie wird keinen Punkte mehr generieren und erst nach der Wiederholungsperiode wieder verfügbar sein.',
      'searchForKeywords': 'Suche',
      'somethingWrong': 'Da ist was schief gegangen',
      'friend': 'Freund',
